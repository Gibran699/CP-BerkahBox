    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('home') ? 'active-orange' : '' }}" href="{{ route('home') }}">Beranda</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="profilDropdown">
                        <li><a class="dropdown-item {{ request()->routeIs('profil.sejarah') ? 'active-orange' : '' }}" href="{{ route('profil.sejarah') }}">Sejarah</a></li>
                        <li><a class="dropdown-item {{ request()->routeIs('profil.visimisi') ? 'active-orange' : '' }}" href="{{ route('profil.visimisi') }}">Visi & Misi</a></li>
                        <li><a class="dropdown-item {{ request()->routeIs('profil.struktur') ? 'active-orange' : '' }}" href="{{ route('profil.struktur') }}">Struktur Organisasi</a></li>
                        <li><a class="dropdown-item {{ request()->routeIs('profil.fasilitas') ? 'active-orange' : '' }}" href="{{ route('profil.fasilitas') }}">Fasilitas</a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('donasi.donasi') ? 'active-orange' : '' }}" href="{{ route('donasi.donasi') }}">Donasi</a>
                </li>
